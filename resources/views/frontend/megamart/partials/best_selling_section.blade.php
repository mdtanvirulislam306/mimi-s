        ...
        <div class="px-3">
            ...
            <div class="d-flex mb-2 mb-md-3 mt-2 mt-md-3 align-items-baseline justify-content-between">
                ...
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="">{{ translate('Top Picked Products') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
            ...
            <!-- Product Section -->
            <div class="px-sm-3">
                <div class="aiz-carousel sm-gutters-16 arrow-none" data-rows="1" data-items="{{ $xxl_items }}" data-xl-items="{{ $xl_items }}" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
