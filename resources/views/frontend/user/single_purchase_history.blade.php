  ...
  <div class="mb-4">
      <div class="d-flex justify-content-between align-items-center mb-2">
          <div>
              <p class="mb-2 fs-16 fw-700 deep-blue mb-0"><a class="deep-blue" href="{{route('purchase_history.details', encrypt($order->id))}}">Order ID - {{ $order->code }}</a></p>
              <span class="text-muted d-block d-md-none fs-12">Date: {{ date('d-m-Y', $order->date) }}</< /span>
          </div>
              ...
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                      ...
                      @if ($order->delivery_status == 'pending' && $order->payment_status == 'unpaid')
                        <a class="dropdown-item text-secondary dropdown-bg-hover" href="{{route('purchase_history.destroy', $order->id)}}"><i class="las la-trash mr-2"></i> {{ translate('Cancel') }}</a>
                      @endif
                  </div>
              </div>
          </div>
      ...
      <div class="row align-items-center mb-2 d-none d-md-flex">
          <div class="col-md-6">
              <div class="row fs-12">
                  ...
                  <div class="col">
                      <span class="text-muted">Date: {{ date('d-m-Y', $order->date) }}</span>
                  </div>
              </div>
          </div>
